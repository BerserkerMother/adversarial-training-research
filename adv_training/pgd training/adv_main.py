...
arg_parser.add_argument('--batch_size', default=128, type=int, help='number of samples in a batch')
...
# model related args
arg_parser.add_argument('--image_size', default=33, type=int, help='resize image to')
...
arg_parser.add_argument('--patch_size', default=11, type=int, help='div_term^2 is number of tiles')
